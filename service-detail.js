...
function displayServiceDetails() {
  ...
  document.getElementById("serviceDescription").textContent = currentService.description
    ? currentService.description[window.currentLang]
    : "Service details available upon request."
  document.getElementById("serviceCategory").textContent = currentService.category
  document.getElementById("serviceCategory2").textContent = currentService.category
  document.getElementById("serviceAddress").textContent = currentService.address || "Contact for location"
  document.getElementById("servicePhone").textContent = currentService.phone
  document.getElementById("servicePhone").href = `tel:${currentService.phone}`
  document.getElementById("serviceEmail").textContent = currentService.email
  document.getElementById("serviceEmail").href = `mailto:${currentService.email}`
